...
for dirname in dirnames:
    ...
    if makeSRplots:
        ...
        makeplot(dirname+"reg_sr2_ewkZ_syst_up",'h_ewkZ_syst_sr2_up_','Missing Transverse Energy',200.,1000.,1,1,0,reg,20)
        makeplot(dirname+"reg_sr2_ewkZ_syst_down",'h_ewkZ_syst_sr2_down_','Missing Transverse Energy',200.,1000.,1,1,0,reg,20)
        makeplot(dirname+"reg_sr2_ewkW_syst_up",'h_ewkW_syst_sr2_up_','Missing Transverse Energy',200.,1000.,1,1,0,reg,20)
        makeplot(dirname+"reg_sr2_ewkW_syst_down",'h_ewkW_syst_sr2_down_','Missing Transverse Energy',200.,1000.,1,1,0,reg,20)
        makeplot(dirname+"reg_sr2_ewkTop_syst_up",'h_ewkTop_syst_sr2_up_','Missing Transverse Energy',200.,1000.,1,1,0,reg,20)
        makeplot(dirname+"reg_sr2_ewkTop_syst_down",'h_ewkTop_syst_sr2_down_','Missing Transverse Energy',200.,1000.,1,1,0,reg,20)
